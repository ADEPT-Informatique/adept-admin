...
$msg = "Bonjour!<br>Nous voulons vous aviser que votre réservation du Hoodie du département informatique à été annulée.<br>
...
header('Location: '.url_for(dirname(dirname(__DIR__)).'/hoodies/index.php'));
